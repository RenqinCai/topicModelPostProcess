...
class _Corpus:
	def __init__(self):
		...
		self.m_minSim = -0.6729050813045061
		self.m_maxSim = 1.0000000000000002
...
####rank the vocabulary for the topic of the article
def rankWords4Topic(corpusObj):
	articleIndex = 0
