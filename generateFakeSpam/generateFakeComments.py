...
def generateFakeComments4Parent(parentName, corpusObj, betaObj, cmntLen):
	for iterIndex in range(50):
		docIndex = iterIndex + 100
		fakeCommentName = "./"+parentName+"_"+str(docIndex)+".json"
		...
		sortedTopicProportionList = sorted(parentObj.m_topicProportion, key=parentObj.m_topicProportion.__getitem__, reverse=True) 
